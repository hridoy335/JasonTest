...
namespace JasonTest.Controllers
{
    public class StudentInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,Role,Address")] StudentInfo studentInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,StudentName,Role,Address")] StudentInfo studentInfo)
        {
            if (ModelState.IsValid)
            {
